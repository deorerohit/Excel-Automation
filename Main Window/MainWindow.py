...
from Extras.ClassAboutUs import ClassAboutUs
from Functionality.ClassAttendenceReport import ClassAttendenceReport
from Functionality.ClassCombineFiles import ClassCombineFiles
from Functionality.ClassCommonColumns import ClassCommonColumns
from Functionality.ClassCommonRows import ClassCommonRows
from Functionality.ClassGenerateGraph import ClassGenerateGraph
from Extras.ClassHelp import ClassHelp
from Functionality.ClassStatistics import ClassStatistics
...
class MainWindow:
    ...
    def __init__(self, master):
        ...
        main_frame = tk.LabelFrame(self.frame,
                                   relief='sunken')
        ...
        yscrollbar = tk.Scrollbar(main_frame,
                                  orient='vertical',
        ...
        status_window = tk.LabelFrame(master,
                                      text="   Status   ",
                                      bg="#ffffff",
                                      padx=10)
        ...
        self.status_label = tk.Label(status_mainframe,
                                     font=myFont,
                                     text='Welcome!!  Add files to continue',
                                     padx=15,
                                     pady=15,
                                     fg="#FF0000",
                                     anchor='w')
        ...
        operation_window = tk.LabelFrame(master,
                                         text="  Operations  ",
                                         bg="#ffffff",
                                         padx=10)
        ...
        self.cmn_all_rb = tk.Radiobutton(operation_window,
                                         font=myFont,
                                         text='Combine All',
                                         variable=self.clicked,
                                         value="Combine All Files",
                                         bg="#ffffff")
        self.cmn_all_rb.place(relx='0.02', rely='0.02')

        self.cmn_col_rb = tk.Radiobutton(operation_window,
                                         font=myFont,
                                         text='Get Common Columns',
                                         variable=self.clicked,
                                         value="Get common columns",
                                         bg="#ffffff")
        self.cmn_col_rb.place(relx='0.4', rely='0.02')

        self.cmn_row_rb = tk.Radiobutton(operation_window,
                                         font=myFont,
                                         text='Get Common Rows',
                                         variable=self.clicked,
                                         value="Get common rows",
                                         bg="#ffffff")
        self.cmn_row_rb.place(relx='0.8', rely='0.02')

        self.cmn_graph_rb = tk.Radiobutton(operation_window,
                                           font=myFont,
                                           text='Generate Graph',
                                           variable=self.clicked,
        ...
        self.cmn_stats_rb = tk.Radiobutton(operation_window,
                                           font=myFont,
                                           text="Statistics",
                                           variable=self.clicked,
                                           value="Statistics", bg="#ffffff")
        self.cmn_stats_rb.place(relx='0.4', rely='0.43')

        self.attend_repo = tk.Radiobutton(operation_window,
                                          font=myFont,
                                          text="Attendance Report",
                                          variable=self.clicked,
                                          value="Attendence Report",
                                          bg="#ffffff")
        self.attend_repo.place(relx='0.8', rely='0.43')

        # Button to add the excel file
        self.addExcelFile = tk.Button(self.frame,
                                      font=myFont,
                                      text="Add File",
                                      padx=10,
                                      pady=5,
        ...
        self.removeFile = tk.Button(self.frame,
                                    font=myFont,
                                    text="Remove File",
                                    padx=10,
                                    pady=5,
        ...
        self.startProcess = tk.Button(master,
                                      font=myFont,
                                      text="Start Process",
                                      padx=20,
                                      pady=5,
        ...
        self.help = tk.Button(master,
                              ...
                              bg="#ede2ef",
                              command=self.help)
        self.help.place(rely=0.923, relx='0.13')

        # Button to open about us window
        self.about_us = tk.Button(master,
                                  text="About Us",
                                  padx=10,
                                  pady=5,
                                  fg="#000000",
        ...
        self.about_us.place(rely=0.923, relx='0.02')

    def help(self):
        top = tk.Toplevel()
        help_obj = ClassHelp(top)
        top.mainloop()

    def about_us(self):
        top = tk.Toplevel()
        aboutus = ClassAboutUs(top)
        top.mainloop()
    ...
    def remove_file(self):
        try:
            ...
            self.status_label.config(text="All file's removed")
    ...
    def get_proper_function_name(self):
        if self.clicked.get() == "Combine All Files":
            ...
            stats_obj = ClassStatistics(self.all_files_list, self.status_label)
            stats_obj.generate_statistics()
